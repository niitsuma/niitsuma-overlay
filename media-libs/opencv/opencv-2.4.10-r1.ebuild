...
pkg_setup() {
	...
	java-pkg-opt-2_pkg_setup
 	...
 	# cl.hpp  cl_ext.h  cl_gl.h  cl_gl_ext.h  cl_platform.h  opencl.h
	# dosym /opt/AMDAPP/include/CL/cl.h /usr/include/CL/cl.h
}
...
src_configure() {
	...
	#	$(cmake-utils_use_with        OPENCLAMDFFT )
		$(cmake-utils_use_with opencl OPENCLAMDBLAS )
	#	$(cmake-utils_use_with        OPENCLAMDBLAS
	...
	# build options
		...
		# -DENABLE_SSE=ON					# these options do nothing but
		# -DENABLE_SSE2=ON					# add params to CFLAGS
		# -DENABLE_SSE3=ON
		# -DENABLE_SSSE3=ON
		# -DENABLE_SSE41=ON
		# -DENABLE_SSE42=ON
	...
	mycmakeargs+=(
		...
		#"-DOPENCL_LIBRARY=/opt/AMDAPP/lib/x86_64"
		"-DOPENCL_LIBRARY=/opt/AMDAPP/lib/x86_64/libOpenCL.so"	
		#"-DOPENCL_LIBRARY=/usr/lib/OpenCL/vendors/amd"
		#"-DOPENCL_LIBRARY=/usr/lib/OpenCL/vendors/amd/libamdocl64.so"	
		#"-DOPENCL_LIBRARY=/usr/lib/OpenCL/vendors/amd/libOpenCL.so"

		"-DOpenCL_DIR=/opt/AMDAPP"
		#"-DOpenCL_DIR=/usr/lib/OpenCL"
