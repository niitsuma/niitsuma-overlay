...
HOMEPAGE="http://members.home.nl/p.a.rombouts/wwwoffle.html"
#SRC_URI="http://www.gedanken.org.uk/software/${PN}/download/${P}.tgz"
SRC_URI=""
EGIT_REPO_URI="https://github.com/niitsuma/wwwoffle-par git://github.com/niitsuma/${PN}.git"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/wwwoffle-2.9i-define.patch	
...
src_install() {
	...
	newinitd "${FILESDIR}/wwwoffle.initd" wwwoffled	
	#newinitd "${FILESDIR}/${PN}-online.initd" wwwoffled-online
	newinitd "${FILESDIR}/wwwoffle-online.initd" wwwoffled-online	
	#newconfd "${FILESDIR}/${PN}-online.confd" wwwoffled-online
	newconfd "${FILESDIR}/wwwoffle-online.confd" wwwoffled-online	
